 ...
 * DV stands for DescriptorVersion and defines the class to use as accepted descriptor versions list
 */
...
public class DescriptorValidatorConfigBean<D, DV>{

    private DV pluginDescriptorVersion;
