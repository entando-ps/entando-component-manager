...
class WidgetProcessorTest extends BaseProcessorTest {
    ...
    @Test
    void canProcessDescriptorV2() throws IOException {
        String widgDescrFile = "src/test/resources/bundle/widgets/my_widget_descriptor_v2.yaml";
        ...
        WidgetDescriptor actual = installableList.get(0).getRepresentation();
        WidgetDescriptor expected = yamlMapper.readValue(new File(widgDescrFile),
